...
var table = document.querySelector('.books-table');
...
var numberOfPagesInput = document.querySelector('#no-of-pages');
var readStatusInput = document.querySelectorAll('.read-status');
var submitBtn = document.querySelector('.submit-btn');
var localStorage = window.localStorage;
var odinLibrary = JSON.parse(localStorage.getItem("odinLibrary"));
renderTable();
...
function showLibrary() {
  tableBody.innerHTML = "";
  odinLibrary.forEach(function (book) {
    var htmlBook = "\n            <tr>\n                <td>".concat(book.title, "</td>\n                <td>").concat(book.author, "</td>\n                <td>").concat(book.noOfPages, "</td>\n                <td><button class='status-btn'>").concat(book.readStatus, "</button></td>\n                <td><button class='remove-btn'>Delete</button></td>\n            </tr>\n        ");
    tableBody.insertAdjacentHTML('afterbegin', htmlBook);
  });
}

var addBookToLibrary = function addBookToLibrary(book) {
  odinLibrary.push(book);
  renderTable();
};

var findBookFromLibrary = function findBookFromLibrary(title) {
  var _iterator = _createForOfIteratorHelper(odinLibrary),
      _step;
...
var deleteBookFromLibrary = function deleteBookFromLibrary(index) {
  odinLibrary.splice(index, index + 1);
};

var changeReadStatus = function changeReadStatus(index) {
...
var handleSubmit = function handleSubmit(event) {
  ...
  var book = new Book(title, author, numberOfPages, readStatus);
...
},{"uuid":"node_modules/uuid/dist/esm-browser/index.js"}],"../../../../../home/vaibhavsethia07/.nvm/versions/node/v16.13.2/lib/node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
...
},{}]},{},["../../../../../home/vaibhavsethia07/.nvm/versions/node/v16.13.2/lib/node_modules/parcel-bundler/src/builtins/hmr-runtime.js","index.js"], null)
//# sourceMappingURL=/library.e31bb0bc.js.map